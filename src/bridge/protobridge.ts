...
export class HelixBridge {
     ...
     * @returns 
     */
    async getIntercomData(intercomHost: string, ourAddress: string, ourKeypair: IKeypair): Result<any> {
     ...
     */
    public async sendTxStage1(_axiosClient: AxiosInstance): Result<IClientResponse> {
